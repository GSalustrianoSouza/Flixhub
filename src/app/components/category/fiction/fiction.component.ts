...
import { MovieModalComponent } from '../../slides/modal-component/modal-component.component';
...
export class FictionComponent implements OnInit, AfterViewInit {
  ...
  private loadMovies() {
    this.movieService.getTopMoviesByGenre("878" ,this.currentPage).subscribe(
      (data: any[]) => {
        if (data.length > 0) {
